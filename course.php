...
<body>
<a href="crud_course/index.php" class="logout-btn">view course</a>
    ...
    <div class="login-box">
        ...
        <form method="post" action="">
            <input type="text" name="name" placeholder="enter course name" required>
             ...
             <input type="text" name="major" placeholder="enter majorty" required>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name = ($_POST['name']);
     $code = ($_POST['code']);
     $major = ($_POST['major']);
    $stmt = $conn->prepare("INSERT INTO   course (name,code,major) VALUES (?, ?, ?)");
    if ($stmt === false) {
        die("Prepare failed: " . $conn->error);
    }
    $stmt->bind_param("sss", $name,$code,$major);
if (!$stmt->execute()) {
